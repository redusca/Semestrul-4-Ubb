namespace Interfata
{
    partial class LoginController
    {
        ...
        private void InitializeComponent()
        {
            ...
            SignInText.Location = new Point(3, 309);
            SignInText.Name = "SignInText";
            SignInText.Size = new Size(175, 20);
            SignInText.TabIndex = 5;
            SignInText.Text = "No account? Create one :\r\n";
            // 
            // SignInButton
            // 
            SignInButton.AutoSize = true;
            SignInButton.ForeColor = Color.Blue;
            SignInButton.Location = new Point(175, 309);
            SignInButton.Name = "SignInButton";
            SignInButton.Size = new Size(54, 20);
            SignInButton.TabIndex = 6;
            SignInButton.Text = "Sign In\r\n";
            SignInButton.DoubleClick += SignInButton_DoubleClick;
            SignInButton.MouseLeave += SingInButton_MouseLeave;
            SignInButton.MouseHover += SingInButton_MouseHover;
            // 
            // LoginController
            // 
