...
namespace restApi.Controllers
{
    ...
    public class ProbaController : ControllerBase
    {
        ...
        public ActionResult<string> Add([FromBody] ProbaDTO dto)
        {
            try
            {
                var id = _probaService.Add(dto.Nume, Enum.Parse<Categorie>(dto.Categorie),dto.arbitruId);
    ...
    public class ProbaDTO
    {
        ...
        public int arbitruId { get; set; }

        public ProbaDTO() { }

        public ProbaDTO(string nume, string categorie, int arbitruId)
        {
            Nume = nume;
            Categorie = categorie;
