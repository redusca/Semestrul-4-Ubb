...
namespace networking.DTO
{
    internal class DTOutils
    {
        ...
        {
            return new UserDTO(arbitru.Id, arbitru.Nume, arbitru.Username, arbitru.Parola, arbitru.Id_proba);
        }

        public static RezultatDTO getDTO(Rezultat rezultat)
        {
            return new RezultatDTO(rezultat.Proba.Id, rezultat.Participant.Id, rezultat.Participant.Nume, rezultat.Participant.Prenume, rezultat.numar_puncte);
        }
